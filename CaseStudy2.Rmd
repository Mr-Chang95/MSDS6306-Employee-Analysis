...
As we build and analyze our KNN model, we find that KNN is not the best model to use. Our accuracy is abysmal. Our sensitivity is only slightly better at .6471 while our specificity is worse at 0.7719. As a result, we will move on to a different model.   
```{r}
